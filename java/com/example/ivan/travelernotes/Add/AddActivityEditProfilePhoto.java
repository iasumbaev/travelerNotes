...
public class AddActivityEditProfilePhoto extends AppCompatActivity {
    ...
    private Context mContext = AddActivityEditProfilePhoto.this;
    ...
    private void setupViewPager() {
        ...
        adapter.addFragment(new GalleryFragmentEditProfilePhoto());
    ...
    public void verifyPermissions(String[] permissions) {
        ...
        ActivityCompat.requestPermissions(
                AddActivityEditProfilePhoto.this,
                permissions,
    ...
    public boolean checkPermissions(String permission) {
        ...
        int permissionRequest = ActivityCompat.checkSelfPermission(AddActivityEditProfilePhoto.this, permission);
