...
public class PhotoFragmentEditProfilePhoto extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        btnLauncCamera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(((AddActivityEditProfilePhoto)getActivity()).getCurrentTabNumber() == PHOTO_FRAGMENT_NUM) {
                        if(((AddActivityEditProfilePhoto)getActivity()).checkPermissions(Permissions.CAMERA_PERMISSION[0])) {
    ...
    private boolean isRootTask() {
        if(((AddActivityEditProfilePhoto)getActivity()).getTask() == 0) {
            return true;
        } else {
            return false;
        }
