...
public class UniversalImageLoader {
    ...
    public ImageLoaderConfiguration getConfig() {
        DisplayImageOptions defaultsOptions = new DisplayImageOptions.Builder().
     ...
     * are being changed in the Fragment/Activity - OR of they are being set in a list or a grid
     * @param imgURL
     * @param image
     * @param mProgressBar
     * @param append
